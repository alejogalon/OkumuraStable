...
class HorsesStablePage extends StatefulWidget {
  const HorsesStablePage({Key? key}) : super(key: key);

  @override
  State<HorsesStablePage> createState() => _HorsesStablePageState();
}


class _HorsesStablePageState extends State<HorsesStablePage> {
  @override
